...
export class PositionHelper {
    ...
    static fromBoardPosition(column, line, check = false) {
        if (csty.isColumn(column)) {
            column = cscnv.toColumnIndex(column);
        }
    ...
    static _ORTHOGONAL_MOVES = [[0, 2], [0, -2], [1, 1], [1, -1], [-1, 1], [-1, -1]];
    static _DIAGONAL_MOVES = [[2, 0], [-2, 0], [1, 3], [1, -3], [-1, 3], [-1, -3]];
    static _KNIGHT_MOVES = [[3, 1], [3, -1], [-3, 1], [-3, -1],
        [2, 4], [1, 5], [2, -4], [1, -5],
        [-2, 4], [-1, 5], [-2, -4], [-1, -5]];
    ...
    static isEvenLinesColumnIndex = (i) => i % 2 != 0;
}
